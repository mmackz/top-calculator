...
function onButtonPress(value) {
   ...
   // adjusts font-size of string based on length
   adjustByLength();

   // formats and updates display element
   formatDisplay(value);
}
   ...
   if (Number.isInteger(+event.key)) {
      ...
      switch (event.key) {
         ...
         case "=":
            ...
            break;
         case "/":
            onButtonPress("divide");
            break;
         case "*":
            onButtonPress("multiply");
            break;
         case "+":
            onButtonPress("plus");
            break;
...
// give attribution to design inspiration inside console
console.log("style and layout inspired by Víctor Arenas https://dribbble.com/shots/2858221-Daily-UI-004-Calculator-UI-Design")
console.log("gradients from https://uigradients.com")